...
Pod::Spec.new do |spec|
  ...
  spec.source       = { :git => "https://github.com/LahiruChathuranga/EMDAlertController.git", :tag => "0.1.5" }
  spec.source_files  = "EMDAlertController/EMDAlertController/CustomAlertClasses/*.{swift}"
  spec.frameworks = "UIKit", "PopupDialog"
  spec.resources = "EMDAlertController/EMDAlertController/CustomAlertXibs/*.{xib,xcassets}"
