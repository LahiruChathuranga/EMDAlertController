...
public class EMDAlertController: UIViewController {
    ...
    public func showAlert(title: String?, message: String?, alertType: AlertType, image: AlertImage, buttonBackground: ButtonBackgroundColor, buttonTextColor: ButtonTextColor, okAction: String = "Dismiss", handler: (() -> Void)?) {
        ...
        switch alertType {
        case .success:
            showSuccessAlert(title: title, message: message ?? "", buttonBackground: alertButtonColor ?? Constant.Colors.sucessButton, image: alertImage ??  ImageHelper.loadImage(name: "ic_success")!, buttonTextColor: alertButtonTextColor ?? .white, okAction: okAction , handler: {
        ...
        case .error:
            showErrorAlert(title: title, message: message ?? "", buttonBackground: alertButtonColor ?? Constant.Colors.errorButton, image: alertImage ??  ImageHelper.loadImage(name: "ic_error")!, buttonTextColor: alertButtonTextColor ?? .white, okAction: okAction , handler: {
                if let _handler = handler {
                    _handler()
                }
            })
        case .warning:
            showWarningAlert(title: title, message: message ?? "", buttonBackground: alertButtonColor ?? Constant.Colors.warningButton, image: alertImage ??  ImageHelper.loadImage(name: "ic_warning")!, buttonTextColor: alertButtonTextColor ?? .white, okAction: okAction , handler: {
                if let _handler = handler {
                    _handler()
                }
            })
        case .info:
            showInfoAlert(title: title, message: message ?? "", buttonBackground: alertButtonColor ?? Constant.Colors.infoButton, image: alertImage ??  ImageHelper.loadImage(name: "ic_info")!, buttonTextColor: alertButtonTextColor ?? .white, okAction: okAction , handler: {
                if let _handler = handler {
                    _handler()
                }
            })
    ...
    public func showConfirmationAlert(title: String?, message: String?, image: AlertImage, cancelButtonBackground: ButtonBackgroundColor, cancelButtonTextColor: ButtonTextColor,  okButtonBackground: ButtonBackgroundColor, okButtonTextColor: ButtonTextColor, cancelAction: String = "Cancel", okAction: String = "Ok", handler: @escaping (() -> Void)) {
        ...
        showConfirmationAlert(title: title, message: message, image: alertImage ?? ImageHelper.loadImage(name: "ic_confirm")!, cancelButtonBackground: alertCancelButtonColor ?? Constant.Colors.confirmationCancelButton, cancelButtonTextColor: alertCancelButtonTextColor ?? .white, okButtonBackground: alertButtonColor ?? Constant.Colors.confirmationOkButton, okButtonTextColor: alertButtonTextColor ?? .white, cancelAction: cancelAction ?? "Cancel", okAction: okAction ?? "Ok", handler: {
            handler()
    ...
    private func showSuccessAlert(title: String?, message: String, buttonBackground: UIColor = Constant.Colors.sucessButton, image: UIImage = ImageHelper.loadImage(name: "ic_success")!, buttonTextColor: UIColor = .white, okAction: String = "Done", handler: @escaping (() -> Void)) {
    ...
    private func showWarningAlert(title: String?, message: String, buttonBackground: UIColor = Constant.Colors.warningButton, image: UIImage = ImageHelper.loadImage(name: "ic_warning")!, buttonTextColor: UIColor = .white, okAction: String = "Dissmiss", handler: @escaping (() -> Void)) {
    ...
    private func showErrorAlert(title: String?, message: String, buttonBackground: UIColor = Constant.Colors.errorButton, image: UIImage = ImageHelper.loadImage(name: "ic_error")!, buttonTextColor: UIColor = .white, okAction: String = "Ok", handler: @escaping (() -> Void)) {
    ...
    private func showInfoAlert(title: String?, message: String, buttonBackground: UIColor = Constant.Colors.infoButton, image: UIImage = ImageHelper.loadImage(name: "ic_info")!, buttonTextColor: UIColor = .white, okAction: String = "Ok", handler: @escaping (() -> Void) ) {
